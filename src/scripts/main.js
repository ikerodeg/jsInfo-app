...
function resaltarPalabras() {
  ...
  elements.forEach(el => {
    ...
    .replace(/'([^']*)'/g, '<span class="lim1">\'$1\'</span>')
    .replace(/(?<!\S)(return|continue;|break|break;|new|delete|throw|export|import|yield|extends|static|of|instanceof|default|debugger;|return;)(?!\S)/g, '<span class="fuc2">$&</span>')  //keys
