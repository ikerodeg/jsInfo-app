...
function resaltarPalabras() {
  ...
  elements.forEach(el => {
    ...
    .replace(/\b(for|forEach|switch|if|else|get|set|typeof|bind|constructor|add|has|revocable|eval|alert|confirm|prompt|Event|fetch|XMLHttpRequest|parseFloat|parseInt)\b/g, '<span class="mari3">$1</span>') //funciones
    .replace(/\b(apply|length|log|getElementById|querySelector|querySelectorAll|getElementByTagName|getElementsByTagName|getElementByClassName|getElementsByClassName|getElementsByName|matches|closest|createElement|append|appendChild|createTextNode|createComment|classList|from|className|addEventListener|onclick|removeEventListener|dispatchEvent|warn|debug|then)\b/g, '<span class="turq1">$1</span>')  //métodos
    .replace(/\b(true|false|undefined|null)\b/g, '<span class="lim3">$1</span>')
    ...
    .replace(/\b(this|Array|Error|Object|console|Proxy|Reflect|Map|Set|WeakMap|document|body|HTMLBodyElement)\b/g, '<span class="huev3">$1</span>')   //Objetos
